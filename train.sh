...
python train_jscc.py --ckpt_addr '' --in_channels 8 --out_channels 8 --batch_size 64 --device 2 --max_epoches 1000 --check_val_every_n_epoch 50 --save_ckpt_every_n_epochs 100 --fast_dev_run True --channel 'Awgn'
#awgn deepjscc 1/12
